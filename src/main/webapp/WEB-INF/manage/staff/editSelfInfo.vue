<!-- 修改员工自身信息 -->
<template id="editSelfInfo-template">
	<div>
		<div class="main">
			<div class="data-form label-width-blank userModule" >
				<el-form label-width="auto"  @submit.native.prevent>
					...
					<el-form-item label="备注"  :error="error.userDesc"  >
						<el-input v-model.trim="userDesc" maxlength="150" :disabled="true" clearable="true" show-word-limit></el-input>					
					</el-form-item>
					...
					<el-form-item label="是否使用" :error="error.enabled">
					...
					<el-form-item label="用户角色" >
						<el-checkbox-group v-model="sysRolesId">
						    <el-checkbox :label="roles.id" :disabled="true" :checked="roles.selected" v-for="roles in rolesList">{{roles.name}}</el-checkbox>
						</el-checkbox-group>
					</el-form-item>
...
//修改员工自身信息
export default({
	name: 'editSelfInfo',//组件名称，keep-alive缓存需要本参数
	template : '#editSelfInfo-template',
	inject:['reload'], 
	data : function data() {
		return {
