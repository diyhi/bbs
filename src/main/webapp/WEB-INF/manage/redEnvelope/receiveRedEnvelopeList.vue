<!-- 收红包列表 -->
<template id="receiveRedEnvelopeList-template">
	<div>
		<div class="main">
			<div class="navbar">
						...
						<template #default="scope">
							<el-popover effect="light" trigger="hover" placement="top">
					        	<template #default>
						            ...
						            <p>用户名称: {{scope.row.giveUserName}}</p>
					        	</template>
					        	<template #reference>
					          		<div class="avatar-wrapper" >
										...
										<div class="avatar-text">{{scope.row.giveUserName}}</div>
									</div>
					        	</template>
					        </el-popover>
				    	</template>
...
//收红包列表
export default({
	name: 'receiveRedEnvelopeList',//组件名称，keep-alive缓存需要本参数
	...
	created : function created() {
		...
		this.queryReceiveRedEnvelopeList();
	...
	methods : {
		...
		queryReceiveRedEnvelopeList : function() {
			...
			_self.tableData = []; 
			 ...
			 _self.$ajax.get('control/redEnvelope/receiveRedEnvelope/list', {
				 params: {
					id :_self.id,
