	...
	<div>
		<div class="main">
			<div class="navbar">
				...
				<el-button type="primary" plain size="small" @click="reductionTopic($event)">还原</el-button>
...
//用户的全部话题列表
export default({
	name: 'allTopic',//组件名称，keep-alive缓存需要本参数
	template : '#allTopic-template',
	inject:['reload'], 
	data : function data() {
		return {
			tableData: [],//表格内容
	...
	methods : {
		...
		queryTopicList : function() {
			...
			this.$ajax.get('control/user/manage', {
			    params: {
			    	method : 'allTopic',
