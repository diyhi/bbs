<!-- 关注列表 -->
<template id="followList-template">
	<div>
...
//关注列表
export default({
	name: 'followList',//组件名称，keep-alive缓存需要本参数
	template : '#followList-template',
	inject:['reload'], 
	data : function data() {
		return {
			tableData: [],//表格内容
	...
	methods : {
		...
		queryFollowList : function() {
			...
			_self.tableData = []; 
			 ...
			 _self.$ajax.get('control/follow/list', {
				 params: {
					id :_self.id,
