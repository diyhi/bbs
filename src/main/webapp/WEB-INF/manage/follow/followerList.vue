<!-- 粉丝列表 -->
<template id="followerList-template">
	<div>
...
//粉丝列表
export default({
	name: 'followerList',//组件名称，keep-alive缓存需要本参数
	template : '#followerList-template',
	inject:['reload'], 
	data : function data() {
		return {
			tableData: [],//表格内容
	...
	methods : {
		...
		queryFollowerList : function() {
			...
			_self.tableData = []; 
			 ...
			 _self.$ajax.get('control/follower/list', {
				 params: {
					id :_self.id,
