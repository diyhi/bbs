...
#
# Structure for table "collectregistrationinfo"
#

CREATE TABLE `collectregistrationinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ip` varchar(45) DEFAULT NULL,
  `registrationTime` datetime DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `collectRegistrationInfo_1_idx` (`ip`,`registrationTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "collectsensitivewordsinfo"
#

CREATE TABLE `collectsensitivewordsinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `extraParameterId` varchar(130) DEFAULT NULL,
  `ip` varchar(45) DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `parameterId` varchar(70) DEFAULT NULL,
  `postTime` datetime DEFAULT NULL,
  `riskControlModelId` int(11) DEFAULT NULL,
  `sensitiveWord` longtext,
  `sensitiveWordsNumber` int(11) DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `collectSensitiveWordsInfo_1_idx` (`userName`,`postTime`,`sensitiveWordsNumber`,`riskControlModelId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "collectuserpostinfo"
#

CREATE TABLE `collectuserpostinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ip` varchar(45) DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `parameterId` varchar(70) DEFAULT NULL,
  ...
  `sensitiveWord` longtext,
  PRIMARY KEY (`id`),
  KEY `collectUserPostInfo_1_idx` (`userName`,`postTime`),
  KEY `collectUserPostInfo_2_idx` (`ip`,`postTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
#
# Structure for table "filelock"
#

CREATE TABLE `filelock` (
  `id` varchar(36) NOT NULL,
  `filePath` varchar(190) DEFAULT NULL,
  `lockTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fileLock_1_idx` (`filePath`),
  KEY `fileLock_2_idx` (`lockTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "filesysteminterface"
#

CREATE TABLE `filesysteminterface` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dynamicParameter` longtext,
  `enable` bit(1) NOT NULL,
  `interfaceProduct` int(11) DEFAULT NULL,
...
#
# Structure for table "frontendapi"
#

CREATE TABLE `frontendapi` (
   `id` int(11) NOT NULL AUTO_INCREMENT,
   `configData` longtext,
   `httpMethod` varchar(30) DEFAULT NULL,
   `name` varchar(100) DEFAULT NULL,
   `requiresLogin` bit(1) DEFAULT NULL,
   `routeEnumMapper` varchar(100) DEFAULT NULL,
   `url` varchar(100) DEFAULT NULL,
   PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "frontendsettings"
#
...
#
# Structure for table "mediaprocesssetting"
#

CREATE TABLE `mediaprocesssetting` (
  `id` int(11) NOT NULL,
  `segmentLocation` int(11) DEFAULT NULL,
  `segmentTime` int(11) DEFAULT NULL,
  `version` bigint(20) DEFAULT NULL,
  `watermark` bit(1) DEFAULT NULL,
  `watermarkDistance_x` int(11) DEFAULT NULL,
  `watermarkDistance_y` int(11) DEFAULT NULL,
  `watermarkFullPathName` varchar(255) DEFAULT NULL,
  `watermarkPosition` int(11) DEFAULT NULL,
  `videoFrameRate` int(11) DEFAULT NULL,
  `remoteSegmentSecret` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
#
# Structure for table "penaltyipinfo"
#

CREATE TABLE `penaltyipinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `banEndTime` datetime DEFAULT NULL,
  ...
  `remark` longtext,
  PRIMARY KEY (`id`),
  KEY `penaltyIpInfo_1_idx` (`ip`,`createTime`),
  KEY `penaltyIpInfo_2_idx` (`ip`,`banEndTime`,`createTime`),
  KEY `penaltyIpInfo_3_idx` (`banEndTime`,`createTime`),
  KEY `penaltyIpInfo_4_idx` (`createTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "penaltypostinfo"
#

CREATE TABLE `penaltypostinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `createTime` datetime DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `parameterId` varchar(70) DEFAULT NULL,
  ...
  `sensitiveWord` longtext,
  `userName` varchar(30) DEFAULT NULL,
  `penaltyParameter` longtext,
  `extraParameterId` varchar(130) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `penaltyPostInfo_1_idx` (`createTime`),
  KEY `penaltyPostInfo_2_idx` (`parameterId`,`module`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "penaltyuserinfo"
#

CREATE TABLE `penaltyuserinfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `banEndTime` datetime DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `riskControlModelId` int(11) DEFAULT NULL,
  `staffAccount` varchar(30) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `unblockTime` datetime DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  `penaltyParameter` longtext,
  PRIMARY KEY (`id`),
  KEY `penaltyUserInfo_1_idx` (`banEndTime`,`status`,`createTime`),
  KEY `penaltyUserInfo_2_idx` (`createTime`),
  KEY `penaltyUserInfo_3_idx` (`userName`,`banEndTime`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
#
# Structure for table "privatemessage_0"
#
...
#
# Structure for table "riskcontrolmodel"
#

CREATE TABLE `riskcontrolmodel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `createDate` datetime DEFAULT NULL,
  ...
  `version` int(11) DEFAULT NULL,
  `type` int(11) DEFAULT NULL,
  `associateSensitiveWord` longtext,
  `penaltyParameter` longtext,
  `remark` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
#
# Structure for table "risksensitivewords"
#

CREATE TABLE `risksensitivewords` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `words` longtext,
...
#
# Structure for table "voteoption"
#
...
CREATE TABLE `voteoption` (
  ...
  `sort` int(11) DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `sourceParameterId` varchar(70) DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `voteOption_1_idx` (`userName`),
  KEY `voteOption_2_idx` (`voteThemeId`,`sort`),
  KEY `voteOption_3_idx` (`sourceParameterId`,`module`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `voterecord` (
  ...
  `ip` varchar(45) DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  `voteOptionId` varchar(32) DEFAULT NULL,
  `voteThemeId` varchar(32) DEFAULT NULL,
  `voteTime` datetime DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `sourceParameterId` varchar(70) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `voteRecord_1_idx` (`userName`,`voteTime`),
  KEY `voteRecord_2_idx` (`voteThemeId`,`userName`),
  KEY `voteRecord_3_idx` (`voteOptionId`,`voteTime`),
  KEY `voteRecord_4_idx` (`voteThemeId`,`voteTime`),
  KEY `voteRecord_5_idx` (`sourceParameterId`,`module`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#
# Structure for table "votetheme"
#
...
CREATE TABLE `votetheme` (
  ...
  `isStaff` bit(1) DEFAULT NULL,
  `maxChoice` int(11) DEFAULT NULL,
  `module` int(11) DEFAULT NULL,
  `sourceParameterId` varchar(70) DEFAULT NULL,
  `title` varchar(190) DEFAULT NULL,
  `userName` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `voteTheme_1_idx` (`userName`),
  KEY `voteTheme_2_idx` (`sourceParameterId`,`module`),
  KEY `voteTheme_3_idx` (`createDate`),
  KEY `voteTheme_4_idx` (`userName`,`isStaff`,`createDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;