package cms.component.fileSystem.localImpl;
...
public class LocalFileComponent {
	private static final Logger logger = LogManager.getLogger(LocalFileComponent.class);
    ...
    public void converterImage(String resFilePath,String newFilePath,String suffix)
		...
		if(file.isFile() &&file.exists()){
			...
			if("png".equalsIgnoreCase(old_suffix)){
				...
				if(old_suffix.equals(suffix)){//如果同后缀，则直接复制
