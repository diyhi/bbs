package cms.component.filePackage;
 ...
 *
 */
@Component("filePackageComponent")
public class FilePackageComponent {
				...
				for(String id : compressList){
					if("|".equals(id)){//如果压缩根目录
						...
						ZipUtil.pack(PathUtil.defaultExternalDirectory()+File.separator, 
								PathUtil.defaultExternalDirectory()+File.separator+"data"+ File.separator+"filePackage"+ File.separator+zipName,
								PathUtil.defaultExternalDirectory()+File.separator+"data"+ File.separator+"filePackage"+ File.separator,
