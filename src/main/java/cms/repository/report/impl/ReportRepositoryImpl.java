package cms.repository.report.impl;
...
@Repository
@Transactional
public class ReportRepositoryImpl extends DaoSupport<Report> implements ReportRepository {
	private static final Logger logger = LogManager.getLogger(ReportRepositoryImpl.class);
	 ...
	 * @return
	 */
	public int updateReportInfo(Long reportId, Integer status, String processResult, String remark, LocalDateTime processCompleteTime, String staffAccount, Integer version){
	 ...
	 * @return
	 */
	public int updateReportInfo(Long reportId, String reportTypeId,Integer status, String processResult,String reason,String remark,LocalDateTime processCompleteTime,String staffAccount,String imageData,Integer version){
