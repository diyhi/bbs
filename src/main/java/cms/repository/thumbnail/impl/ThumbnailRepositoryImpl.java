package cms.repository.thumbnail.impl;
...
@Repository
@Transactional
public class ThumbnailRepositoryImpl extends DaoSupport<Thumbnail> implements ThumbnailRepository {
	 ...
	 */
	@Transactional(readOnly=true,propagation=Propagation.NOT_SUPPORTED)
	@Cacheable(value="thumbnailRepositoryImpl_cache",key="'default'")
	 ...
	 * @param thumbnail
	 */
	@CacheEvict(value="thumbnailRepositoryImpl_cache",allEntries=true)
