package cms.repository.like.impl;
...
@Repository
@Transactional
public class LikeRepositoryImpl extends DaoSupport<Like> implements LikeRepository {
	private static final Logger logger = LogManager.getLogger(LikeRepositoryImpl.class);
	...
	public Like findById(String likeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.Like_"+tableNumber);
                //获取无参数构造函数
	...
	public TopicLike findTopicLikeById(String topicLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.TopicLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
	...
	public CommentLike findCommentLikeById(String commentLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.CommentLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
	...
	public CommentReplyLike findCommentReplyLikeById(String commentReplyLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.CommentReplyLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
	...
	public QuestionLike findQuestionLikeById(String questionLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.QuestionLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
	...
	public AnswerLike findAnswerLikeById(String answerLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.AnswerLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
	...
	public AnswerReplyLike findAnswerReplyLikeById(String answerReplyLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cms.model.like.AnswerReplyLike_"+tableNumber);
                //获取无参数构造函数
                Constructor<?> constructor = c.getDeclaredConstructor();
