...
import cms.model.user.UserInputValue;
...
@Repository
@Transactional
public class UserCustomRepositoryImpl extends DaoSupport<UserCustom> implements UserCustomRepository {
	 ...
	 */
	@Transactional(readOnly=true,propagation=Propagation.NOT_SUPPORTED)
	@Cacheable(value="userCustomRepositoryImpl_cache",key="'findAllUserCustom_default'")
	 ...
	 */
	@CacheEvict(value="userCustomRepositoryImpl_cache",allEntries=true)
