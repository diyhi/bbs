package cms.repository.sms.impl;
...
@Repository
@Transactional
public class SmsRepositoryImpl extends DaoSupport<SmsInterface> implements SmsRepository {
	private static final Logger logger = LogManager.getLogger(SmsRepositoryImpl.class);
	 ...
	 */
	@CacheEvict(value="smsRepositoryImpl_cache",allEntries=true)
	 ...
	 */
	@Transactional(readOnly=true,propagation=Propagation.NOT_SUPPORTED)
	@Cacheable(value="smsRepositoryImpl_cache",key="'findEnableInterface_default'")
