package cms.repository.thirdParty.impl;
...
@Repository
@Transactional
public class ThirdPartyLoginRepositoryImpl extends DaoSupport<ThirdPartyLoginInterface> implements ThirdPartyLoginRepository {
	 ...
	 */
	@Transactional(readOnly=true,propagation=Propagation.NOT_SUPPORTED)
	@Cacheable(value="thirdPartyLoginRepositoryImpl_cache",key="'findAllValidThirdPartyLoginInterface_default'")
	 ...
	 */
	@CacheEvict(value="thirdPartyLoginRepositoryImpl_cache",allEntries=true)
