    ...
    public void validate(Object target, Errors errors) {
        ...
        if(systemSetting.getAllowRegisterAccountTypeCodeList() != null && systemSetting.getAllowRegisterAccountTypeCodeList().size() >0){
            for(Integer allowRegisterAccountTypeCode : systemSetting.getAllowRegisterAccountTypeCodeList()){
                if(allowRegisterAccountTypeCode != null && !settingComponent.getSupportAccountType().keySet().contains(allowRegisterAccountTypeCode)){
                    errors.rejectValue("allowRegisterAccountType","errors.common", new String[]{"当前账户类型不被支持"},"");
                }
        ...
        if(systemSetting.getAllowLoginAccountTypeCodeList() != null && systemSetting.getAllowLoginAccountTypeCodeList().size() >0){
            for(Integer allowLoginAccountTypeCode : systemSetting.getAllowLoginAccountTypeCodeList()){
                if(allowLoginAccountTypeCode != null && !settingComponent.getSupportAccountType().keySet().contains(allowLoginAccountTypeCode)){
                    errors.rejectValue("allowLoginAccountType","errors.common", new String[]{"当前账户类型不被支持"},"");
                }
        ...
        if(systemSetting.getLogin_submitQuantity() != null){
            if(systemSetting.getLogin_submitQuantity() <0){
                errors.rejectValue("login_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("login_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //发表话题每分钟提交超过
        if(systemSetting.getTopic_submitQuantity() != null){
            if(systemSetting.getTopic_submitQuantity() <0){
                errors.rejectValue("topic_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("topic_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //发表评论每分钟提交超过
        if(systemSetting.getComment_submitQuantity() != null){
            if(systemSetting.getComment_submitQuantity() <0){
                errors.rejectValue("comment_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("comment_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //发表问题每分钟提交超过
        if(systemSetting.getQuestion_submitQuantity() != null){
            if(systemSetting.getQuestion_submitQuantity() <0){
                errors.rejectValue("question_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("question_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //发表答案每分钟提交超过
        if(systemSetting.getAnswer_submitQuantity() != null){
            if(systemSetting.getAnswer_submitQuantity() <0){
                errors.rejectValue("answer_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("answer_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //发表私信每分钟提交超过
        if(systemSetting.getPrivateMessage_submitQuantity() != null){
            if(systemSetting.getPrivateMessage_submitQuantity() <0){
                errors.rejectValue("privateMessage_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("privateMessage_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //AI助手每分钟提交超过
        if(systemSetting.getAiAssistant_submitQuantity() != null){
            if(systemSetting.getAiAssistant_submitQuantity() <0){
                errors.rejectValue("aiAssistant_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("aiAssistant_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //举报每分钟提交超过
        if(systemSetting.getReport_submitQuantity() != null){
            if(systemSetting.getReport_submitQuantity() <0){
                errors.rejectValue("report_submitQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("report_submitQuantity","errors.common", new String[]{"不能为空"},"");
        }
        //举报图片允许最大上传数量
        if(systemSetting.getReportMaxImageUpload() != null){
            if(systemSetting.getReportMaxImageUpload() <0){
                errors.rejectValue("reportMaxImageUpload","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("reportMaxImageUpload","errors.common", new String[]{"不能为空"},"");
        }

        //提交问题最多可选择标签数量
        if(systemSetting.getMaxQuestionTagQuantity() != null){
            if(systemSetting.getMaxQuestionTagQuantity() <0){
                errors.rejectValue("maxQuestionTagQuantity","errors.common", new String[]{"不能小于0"},"");
            }
        }else{
            errors.rejectValue("maxQuestionTagQuantity","errors.common", new String[]{"不能为空"},"");
        }

        //发表话题奖励积分
        if(systemSetting.getTopic_rewardPoint() != null){
            if(systemSetting.getTopic_rewardPoint() <0L){
                errors.rejectValue("topic_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("topic_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }
        //发表评论奖励积分
        if(systemSetting.getComment_rewardPoint() != null){
            if(systemSetting.getComment_rewardPoint() <0L){
                errors.rejectValue("comment_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("comment_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }
        //发表回复奖励积分
        if(systemSetting.getReply_rewardPoint() != null){
            if(systemSetting.getReply_rewardPoint() <0L){
                errors.rejectValue("reply_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("reply_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }

        //提交问题奖励积分
        if(systemSetting.getQuestion_rewardPoint() != null){
            if(systemSetting.getQuestion_rewardPoint() <0L){
                errors.rejectValue("question_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("question_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }
        //提交答案奖励积分
        if(systemSetting.getAnswer_rewardPoint() != null){
            if(systemSetting.getAnswer_rewardPoint() <0L){
                errors.rejectValue("answer_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("answer_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }
        //提交答案回复奖励积分
        if(systemSetting.getAnswerReply_rewardPoint() != null){
            if(systemSetting.getAnswerReply_rewardPoint() <0L){
                errors.rejectValue("answerReply_rewardPoint","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("answerReply_rewardPoint","errors.common", new String[]{"不能为空"},"");
        }
        ...
        if(systemSetting.getQuestionRewardPointMin() != null){
            if(systemSetting.getQuestionRewardPointMin() <0L){
                errors.rejectValue("questionRewardPointMin","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("questionRewardPointMin","errors.common", new String[]{"不能为空"},"");
        }
        //问题悬赏积分上限 空为无限制 0则不允许悬赏积分
        if(systemSetting.getQuestionRewardPointMax() != null){
            if(systemSetting.getQuestionRewardPointMax() <0L){
                errors.rejectValue("questionRewardPointMax","errors.common", new String[]{"必须大于或等于0"},"");
            }
            if(systemSetting.getQuestionRewardPointMax() >999999999999999L){
                errors.rejectValue("questionRewardPointMax","errors.common", new String[]{"不能大于999999999999999"},"");
            }
            if(systemSetting.getQuestionRewardPointMax() > 0L && systemSetting.getQuestionRewardPointMin() != null){
                if(systemSetting.getQuestionRewardPointMin() >=systemSetting.getQuestionRewardPointMax()){
                    errors.rejectValue("questionRewardPointMax","errors.common", new String[]{"不能小于或等于问题悬赏积分下限"},"");
                }
            }
        }
        //问题悬赏金额下限
        if(systemSetting.getQuestionRewardAmountMin() != null){
            if(systemSetting.getQuestionRewardAmountMin().compareTo(new BigDecimal("0")) <0){
                errors.rejectValue("questionRewardAmountMin","errors.common", new String[]{"必须大于或等于0"},"");
            }
        }else{
            errors.rejectValue("questionRewardAmountMin","errors.common", new String[]{"不能为空"},"");
        }
        //问题悬赏金额上限
        if(systemSetting.getQuestionRewardAmountMax() != null){
            if(systemSetting.getQuestionRewardAmountMax().compareTo(new BigDecimal("0")) <0){
                errors.rejectValue("questionRewardAmountMax","errors.common", new String[]{"必须大于或等于0"},"");
            }
            if(systemSetting.getQuestionRewardAmountMax().compareTo(new BigDecimal("99999999")) >0){
                errors.rejectValue("questionRewardAmountMax","errors.common", new String[]{"不能大于99999999"},"");
            }
            if(systemSetting.getQuestionRewardAmountMax().compareTo(new BigDecimal("0")) >0 && systemSetting.getQuestionRewardAmountMin() != null){
                if(systemSetting.getQuestionRewardAmountMin().compareTo(systemSetting.getQuestionRewardAmountMax()) >=0){
                    errors.rejectValue("questionRewardAmountMax","errors.common", new String[]{"不能小于或等于问题悬赏金额下限"},"");
                }
            }
        }
        ...
        if(systemSetting.getGiveRedEnvelopeAmountMin() != null){
            if(systemSetting.getGiveRedEnvelopeAmountMin().compareTo(new BigDecimal("0.01")) <0){
                errors.rejectValue("giveRedEnvelopeAmountMin","errors.common", new String[]{"必须大于或等于0.01"},"");
            }
        }else{
            errors.rejectValue("giveRedEnvelopeAmountMin","errors.common", new String[]{"不能为空"},"");
        }
        //发红包金额上限
        if(systemSetting.getGiveRedEnvelopeAmountMax() != null){
            if(systemSetting.getGiveRedEnvelopeAmountMax().compareTo(new BigDecimal("0")) <0){
                errors.rejectValue("giveRedEnvelopeAmountMax","errors.common", new String[]{"必须大于或等于0"},"");
            }
            if(systemSetting.getGiveRedEnvelopeAmountMax().compareTo(new BigDecimal("99999999")) >0){
                errors.rejectValue("giveRedEnvelopeAmountMax","errors.common", new String[]{"不能大于99999999"},"");
            }
            if(systemSetting.getGiveRedEnvelopeAmountMax().compareTo(new BigDecimal("0")) >0 && systemSetting.getGiveRedEnvelopeAmountMin() != null){
                if(systemSetting.getGiveRedEnvelopeAmountMin().compareTo(systemSetting.getGiveRedEnvelopeAmountMax()) >0){
                    errors.rejectValue("giveRedEnvelopeAmountMax","errors.common", new String[]{"不能小于发红包金额下限"},"");
                }
            }
        }

        if(systemSetting.getTopicMaxVoteOptions() != null){
            if(systemSetting.getTopicMaxVoteOptions() <0){
                errors.rejectValue("topicMaxVoteOptions","errors.common", new String[]{"不能小于0"},"");
            }
        }
        if(systemSetting.getQuestionMaxVoteOptions() != null){
            if(systemSetting.getQuestionMaxVoteOptions() <0){
                errors.rejectValue("questionMaxVoteOptions","errors.common", new String[]{"不能小于0"},"");
            }
        }
        ...
        if(systemSetting.getTopicUnhidePlatformShareProportion() != null){
            if(systemSetting.getTopicUnhidePlatformShareProportion() <0){
                errors.rejectValue("topicUnhidePlatformShareProportion","errors.common", new String[]{"必须大于或等于0"},"");
            }
            if(systemSetting.getTopicUnhidePlatformShareProportion() >100){
                errors.rejectValue("topicUnhidePlatformShareProportion","errors.common", new String[]{"必须小于或等于100"},"");
            }
        }else{
            errors.rejectValue("topicUnhidePlatformShareProportion","errors.common", new String[]{"不能为空"},"");
        }
        //悬赏问答平台分成比例
        if(systemSetting.getQuestionRewardPlatformShareProportion() != null){
            if(systemSetting.getQuestionRewardPlatformShareProportion() <0){
                errors.rejectValue("questionRewardPlatformShareProportion","errors.common", new String[]{"必须大于或等于0"},"");
            }
            if(systemSetting.getQuestionRewardPlatformShareProportion() >100){
                errors.rejectValue("questionRewardPlatformShareProportion","errors.common", new String[]{"必须小于或等于100"},"");
            }
        }else{
            errors.rejectValue("questionRewardPlatformShareProportion","errors.common", new String[]{"不能为空"},"");
        }
        //文件防盗链密钥
        if(systemSetting.getFileSecureLinkSecret() != null && !"".equals(systemSetting.getFileSecureLinkSecret().trim())){
            if(systemSetting.getFileSecureLinkSecret().trim().length() != 16){
                errors.rejectValue("fileSecureLinkSecret","errors.common", new String[]{"密钥必须为16个字符"},"");
            }
        }
        //文件防盗链过期时间
        if(systemSetting.getFileSecureLinkExpire() != null){
            if(systemSetting.getFileSecureLinkExpire() <=0){
                errors.rejectValue("fileSecureLinkExpire","errors.common", new String[]{"不能小于或等于0"},"");
            }
        }else{
            errors.rejectValue("fileSecureLinkExpire","errors.common", new String[]{"不能为空"},"");
        }

        //前台分页数量
        if(systemSetting.getForestagePageNumber() != null){
            if(systemSetting.getForestagePageNumber() <=0){
                errors.rejectValue("forestagePageNumber","errors.common", new String[]{"不能小于或等于0"},"");
            }
        }else{
            errors.rejectValue("forestagePageNumber","errors.common", new String[]{"不能为空"},"");
        }

        //后台分页数量
        if(systemSetting.getBackstagePageNumber() != null){
            if(systemSetting.getBackstagePageNumber() <=0){
                errors.rejectValue("backstagePageNumber","errors.common", new String[]{"不能小于或等于0"},"");
            }
        }
        ...
        if(systemSetting.getTemporaryFileValidPeriod() != null){
            if(systemSetting.getTemporaryFileValidPeriod() <=0){
                errors.rejectValue("temporaryFileValidPeriod","errors.common", new String[]{"必须大于0"},"");
            }
        }else{
            errors.rejectValue("temporaryFileValidPeriod","errors.common", new String[]{"不能为空"},"");
        }
        if(systemSetting.getUserSentSmsCount() != null){
            if(systemSetting.getUserSentSmsCount() <=0){
                errors.rejectValue("userSentSmsCount","errors.common", new String[]{"必须大于0"},"");
            }
        }
        //话题编辑器标签
        if(systemSetting.getTopicEditorTagObject() != null){
            ...
            if(systemSetting.getTopicEditorTagObject().isUploadVideo()){//上传视频
                if(systemSetting.getTopicEditorTagObject().getVideoSize() == null || systemSetting.getTopicEditorTagObject().getVideoSize() <=0){
                    errors.rejectValue("topicEditorTagObject.videoSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            ...
            if(systemSetting.getTopicEditorTagObject().isImage()){//图片
                if(systemSetting.getTopicEditorTagObject().getImageSize() == null || systemSetting.getTopicEditorTagObject().getImageSize() <=0){
                    errors.rejectValue("topicEditorTagObject.imageSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            if(systemSetting.getTopicEditorTagObject().isFile()){//文件
                if(systemSetting.getTopicEditorTagObject().getFileSize() == null || systemSetting.getTopicEditorTagObject().getFileSize() <=0){
                    errors.rejectValue("topicEditorTagObject.fileSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            //允许上传图片格式
            ...
            if(imageFormatList != null && imageFormatList.size() >0){
                ...
                if(imageUploadFormatList != null && imageUploadFormatList.size() >0){
                    A:for(String imageFormat : imageFormatList){
                        ...
                        errors.rejectValue("topicEditorTagObject.imageFormat","errors.common", new String[]{imageFormat+"格式不属于预设格式"},"");
                    }
                }
            }
            //允许上传文件格式
            ...
            if(fileFormatList != null && fileFormatList.size() >0){
                ...
                if(fileUploadFormatList != null && fileUploadFormatList.size() >0){
                    A:for(String fileFormat : fileFormatList){
                        ...
                        errors.rejectValue("topicEditorTagObject.fileFormat","errors.common", new String[]{fileFormat+"格式不属于预设格式"},"");
                    }
                }
            }
            //允许上传视频格式
            ...
            if(videoFormatList != null && videoFormatList.size() >0){
                ...
                if(videoUploadFormatList != null && videoUploadFormatList.size() >0){
                    A:for(String videoFormat : videoFormatList){
                        ...
                        errors.rejectValue("topicEditorTagObject.videoFormat","errors.common", new String[]{videoFormat+"格式不属于预设格式"},"");
                    }
                }
            }
        }
        ...
        if(systemSetting.getEditorTagObject() != null){
            if(systemSetting.getEditorTagObject().isImage()){//图片
                if(systemSetting.getEditorTagObject().getImageSize() == null || systemSetting.getEditorTagObject().getImageSize() <=0){
                    errors.rejectValue("editorTagObject.imageSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            //允许上传图片格式
            ...
            if(imageFormatList != null && imageFormatList.size() >0){
                ...
                if(imageUploadFormatList != null && imageUploadFormatList.size() >0){
                    A:for(String imageFormat : imageFormatList){
                        ...
                        errors.rejectValue("editorTagObject.imageFormat","errors.common", new String[]{imageFormat+"格式不属于预设格式"},"");
                    }
                }
            }
        }
        ...
        if(systemSetting.getQuestionEditorTagObject() != null){
            if(systemSetting.getQuestionEditorTagObject().isImage()){//图片
                if(systemSetting.getQuestionEditorTagObject().getImageSize() == null || systemSetting.getQuestionEditorTagObject().getImageSize() <=0){
                    errors.rejectValue("questionEditorTagObject.imageSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            //允许上传图片格式
            ...
            if(imageFormatList != null && imageFormatList.size() >0){
                ...
                if(imageUploadFormatList != null && imageUploadFormatList.size() >0){
                    A:for(String imageFormat : imageFormatList){
                        ...
                        errors.rejectValue("questionEditorTagObject.imageFormat","errors.common", new String[]{imageFormat+"格式不属于预设格式"},"");
                    }
                }
            }
        }
        ...
        if(systemSetting.getAnswerEditorTagObject() != null){
            if(systemSetting.getAnswerEditorTagObject().isImage()){//图片
                if(systemSetting.getAnswerEditorTagObject().getImageSize() == null || systemSetting.getAnswerEditorTagObject().getImageSize() <=0){
                    errors.rejectValue("answerEditorTagObject.imageSize","errors.common", new String[]{"必须大于0"},"");
                }
            }
            //允许上传图片格式
            ...
            if(imageFormatList != null && imageFormatList.size() >0){
                ...
                if(imageUploadFormatList != null && imageUploadFormatList.size() >0){
                    A:for(String imageFormat : imageFormatList){
                        ...
                        errors.rejectValue("answerEditorTagObject.imageFormat","errors.common", new String[]{imageFormat+"格式不属于预设格式"},"");
                    }
                }
            }
        }
